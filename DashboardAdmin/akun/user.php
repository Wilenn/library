                                    ...
                                    <div class="table-responsive pt-3">
                                        <table class="table table-bordered">
                                                        ...
                                                        <?php if ($item['username'] !== 'abi') : ?>
                                                            <center>
                                                                <div class="action">
                                                                    ...
                                                                    <a href="deleteAdmin.php?id=<?= $item["id"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data member ?');">
                                            ...
                                            if (isset($_POST['update'])) {
                                                ...
                                                $updatedata = mysqli_query($connection, "update user set username='$username', password='$password', sebagai='$sebagai' where id='$id'");
