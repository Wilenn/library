...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="max-width: 100%;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/img/pus.jpg" class="d-block w-100" alt="buku.jpg">
        </div>
        <div class="carousel-item">
          <img src="assets/img/buku2.jpg" class="d-block w-100"  alt="buku2.jpg">
        </div>
        <div class="carousel-item">
          <img src="assets/img/buku3.jpg" class="d-block w-100"  alt="buku3.jpg">
        </div>
      </div>
  ...
  <div class="d-flex flex-wrap justify-content-center">
    <div class="col">
      ...
      <style>
        body {
          background: url('assets/img/beground.jpg') no-repeat center center fixed;
