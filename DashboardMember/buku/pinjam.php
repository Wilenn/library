        ...
        <div class="card mt-4">
          ...
          <div class="card-body">
            <form action="" method="post">
              ...
              <!--Ambil data id admin-->
              <select name="id_user" class="form-select" aria-label="Default select example" placeholder="choose" required>
              ...
              <div class="input-group mb-3 mt-3">
                ...
                <input type="date" name="date1" id="date1" class="form-control" value="<?= $sekarang; ?>" placeholder="id buku" aria-label="tgl_pinjam" required>
              </div>
              <div class="input-group mb-3 mt-3">
                <span class="input-group">Tanggal akhir peminjaman</span>
                <input type="date" name="date2" id="date2" class="form-control" placeholder="tgl_kembali" aria-label="tgl_kembali" required>
              </div>
              <input type="hidden" id="tgl_pinjam" name="tgl_pinjam">
              <input type="hidden" id="tgl_kembali" name="tgl_kembali">

              <a class="btn btn-danger" href="../dashboard.php"> Batal</a>
              <button onclick="convert()" type="submit" class="btn btn-success" name="pinjam">Pinjam</button>
            </form>
          </div>
        </div>
