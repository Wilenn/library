          ...
          ?>
              <tr>
                ...
                <td>
                  <?php
                  if ($item['status'] == '0') {
                    echo '<div><b>Tidak bisa baca</b></div>';
                  } elseif ($item['status'] == '1') {
                  ?>
                    <a href="bacaBuku.php?id_buku=<?= $item['id_buku']; ?>" class="btn btn-primary">Baca</a>
                  <?php
                  } elseif ($item['status'] == '2') {
                    echo '<div><b>Tidak Disetujui</b></div>';
                  } elseif ($item['status'] == '3') {
                    echo '<div><b>Telah Dinonaktifkan</b></div>';
                  }
                  ?>
                </td>
              </tr>
  ...
  <script>
    function kembalikanBuku(idPeminjaman) {
      if (confirm("Apakah Anda yakin ingin mengembalikan buku ini?")) {
        ...
        xhr.open("POST", "daftar_pinjam.php", true);
